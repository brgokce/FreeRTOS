...
void vTask1( void *pvParameters )
{
	...
	for( ;; )
	{
		HAL_UART_Transmit(&huart1, (uint8_t *)"Gorev 1 Calisiyor\r\n", 40, 0xFFFF);
		HAL_UART_Transmit(&huart1, (uint8_t *)"Gorev 2'nin onceligi 1 arttiriliyor\r\n", 40, 0xFFFF);
...
void vTask2( void *pvParameters )
{
	...
	for( ;; )
	{
		HAL_UART_Transmit(&huart1, (uint8_t *)"Gorev 2 Calisiyor\r\n", 40, 0xFFFF);
		HAL_UART_Transmit(&huart1, (uint8_t *)"Gorev 2'nin onceligi 2 dusuruluyor\r\n", 40, 0xFFFF);
