...
int main(void)
{
  ...
  static const char *Gorev3Metin = "ulIdleCycleCount \r\n";

  xTaskCreate(vTask1, "Task 1", configMINIMAL_STACK_SIZE,  (void*)Gorev1Metin, 1, NULL );
  xTaskCreate(vTask2, "Task 2", configMINIMAL_STACK_SIZE,  (void*)Gorev2Metin, 3, NULL );
  xTaskCreate(vTaskFunction, "vTaskFunction ", configMINIMAL_STACK_SIZE,  (void*)Gorev3Metin, 2, NULL );
...
void vTask1 (void * pvParameters)
{
   ...
   for (;;)
   {
	HAL_UART_Transmit(&huart1, (uint8_t *)GorevAdi, 19, 0xFFFF);;
...
//void vApplicationIdleHook( void )
//{
///* kanca fonksiyonu hiçbir sey yapmaz sadece bir sayaci arttirir. */
//	ulIdleCycleCount++;
//}
...
void vTaskFunction (void * pvParameters)
{
   ...
   for (;;)
   {
	   sprintf(buffer,"Idle Cycle Count %d\r\n",  ulIdleCycleCount);
